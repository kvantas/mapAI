...
This vignette demonstrates an advanced workflow for analyzing and correcting a map with complex, non-linear distortions. While the `Getting Started with mapAI: A Complete Workflow` vignette used a synthetic data set, this one focuses on a more challenging real-world scenario.
