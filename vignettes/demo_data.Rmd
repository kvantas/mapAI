...
```{r apply-and-visualize, fig.dim = c(6, 6), out.width="100%"}
...
```{r plot-surfaces, fig.dim = c(6, 6), out.width="100%"}
...
```{r plot-airy, fig.dim = c(6, 6), out.width="100%"}
...
```{r plot-indicatrices, fig.dim = c(6, 6), out.width="100%"}
