...
#>    -> Homologous points saved to: /tmp/RtmpiCSr6e/demo_gcps.csv
#>    -> Distorted map saved to: /tmp/RtmpiCSr6e/demo_map.shp
#> Writing map to: /tmp/RtmpiCSr6e/demo_map.tif
#> Map successfully written.
#>    -> Distorted raster saved to: /tmp/RtmpiCSr6e/demo_map.tif
...
#> Reading layer `demo_map' from data source `/tmp/RtmpiCSr6e/demo_map.shp' using driver `ESRI Shapefile'
...
#> Writing map to: /tmp/RtmpiCSr6e/corrected_demo_map.tif
#> Map successfully written.
```
