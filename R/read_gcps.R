...
summary.gcp <- function(object, ...) {
  ...
  cat("  X:", range(object$source_x), "\n")
  cat("  Y:", range(object$source_y), "\n")
  cat("Target Coordinates Range:\n")
  cat("  X:", range(object$target_x), "\n")
  cat("  Y:", range(object$target_y), "\n")
  cat("Displacement Vectors Range:\n")
  cat("  dx:", range(object$dx), "\n")
  cat("  dy:", range(object$dy), "\n")
  cat("Mean Displacement:\n")
  cat("  Mean dx:", mean(object$dx), "\n")
  cat("  Mean dy:", mean(object$dy), "\n")
  cat("Standard Deviation of Displacement:\n")
  cat("  SD dx:", sd(object$dx), "\n")
  cat("  SD dy:", sd(object$dy), "\n")
  cat("2D RMSE of Displacement:\n")
  rmse_2d <- sqrt(mean(object$dx^2 + object$dy^2))
  cat("  RMSE:", rmse_2d, "\n")
  invisible(object)
}
