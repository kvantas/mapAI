...
#'
#' @description A dataset containing vector map parcels (polygons from a
#'   cadastral map) that are intended to be corrected using geospatial
#'   transformation methods.
#'
#' @format An `sf` object with 493 parcel polygon geometries and several
#'   variables:
#' \describe{
...
#'   \item{geometry}{`sfc_POLYGON` or `sfc_MULTIPOLYGON`. The `sf` polygon
#'   geometry representing the parcels in the target CRS (EPSG:2100).}
#' }
