...
# Read the generated GCPs into an sf object for use in tests
...
test_that("helmert model in train_pai_model returns a valid object", {
  ...
  helmert_model <- train_pai_model(gcp_data, method = "helmert")
...
test_that("helmert method handles co-located source points gracefully", {
  ...
  expect_error(
    train_pai_model(bad_gcps_sf, method = "helmert"),
