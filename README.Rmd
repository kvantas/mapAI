...
The `mapAI` package provides a comprehensive, end-to-end toolkit in R for the **Positional Accuracy Improvement (PAI)** of vector maps.
The package is designed for researchers and practitioners in Geoinformatics and GIS who need not only to to improve the geometric quality of vector maps but also to understand and quantify the nature of their geometric distortions.
...
2.  **Train a Model**: Select from a suite of PAI models (`helmert`, `lm`, `tps`, `rf`, `svmLinear`, `svmRadial`, `gam`) to learn the distortion pattern.
...
plot_shear
```
These plots provide a detailed map of where the model learned to apply  stretching, shrinking, and shearing, offering insights that may correlate with physical map degradation or historical cartographic techniques.
