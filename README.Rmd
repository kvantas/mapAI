...
The `mapAI` package provides a comprehensive and accessible framework for Positional Accuracy Improvement (PAI) of vector geospatial data. This package’s main contributions  are: 

(a) the unification of a set of PAI methods from classical adjustments to statistical and machine learning algorithms, within a framework engineered to modify the geometry of spatial features; 

(b) the application of modern best practices regarding predictive accuracy assessment using various validation methods, and;

(c) the integration of distortion analysis into the PAI workflow, providing powerful diagnostics.
